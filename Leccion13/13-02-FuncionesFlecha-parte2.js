...
const funcionConParametros = mensaje => console.log( mensaje );//determinar variable|Nombre variable|=|parametro a recibir (si es mas de uno usa parentesis)|=>|datos a realizar
...
console.log( funcionConVariosParametros(9,5));
